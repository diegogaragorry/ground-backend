...
exports.handleDLocalCallback = exports.handleDLocalNotification = exports.startProEarlyCheckout = exports.getBillingSummary = void 0;
...
async function persistPaymentStatus(paymentId, payload, source) {
    ...
    const paymentRecord = await prisma_1.prisma.billingSubscription.findFirst({
        where: {
    ...
    switch (normalizedStatus) {
        ...
        case "COMPLETED":
            ...
            periodEndsAt = addMonths(now, Math.max((0, billing_service_1.getPlanDurationMonths)(paymentRecord.planCode), 1));
            break;
        case "PENDING":
        case "CREATED":
        case "IN_PROCESS":
        ...
        case "EXPIRED":
        case "DECLINED":
            nextStatus = paymentRecord.status === client_1.BillingSubscriptionStatus.ACTIVE ? client_1.BillingSubscriptionStatus.PAST_DUE : client_1.BillingSubscriptionStatus.INCOMPLETE;
    ...
    const updated = await prisma_1.prisma.billingSubscription.update({
        ...
        data: {
            status: nextStatus,
            currentPeriodStartedAt: nextStatus === client_1.BillingSubscriptionStatus.ACTIVE ? now : paymentRecord.currentPeriodStartedAt,
            ...
            metadata: {
                ...
                lastDlocalOrderId: (0, dlocal_service_1.extractOrderId)(payload) || paymentRecord.metadata?.orderId,
