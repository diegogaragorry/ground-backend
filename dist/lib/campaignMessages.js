...
function buildSpecialGuestCampaignEmail(language) {
    ...
    if (locale === "es") {
        return {
            ...
            html: wrapCampaignHtml({
                ...
                intro: "Gracias por todo el feedback que nos vienes compartiendo. Nos esta ayudando a mejorar Ground mucho mas rapido.",
                bodyLead: "Queremos devolverte ese acompanamiento extendiendo tu acceso Early Stage a 4 meses sin costo e invitarte a ver lo ultimo que fuimos sumando en el producto.",
                highlights: [
                ...
                recoveryBody: "Entra en Cuenta y actualiza Ubicacion y Telefono. Si algun dia pierdes tu clave, estos datos son clave para recuperar el acceso. Con E2EE, si no tienes recovery bien configurado, podrias no poder recuperar tu informacion historica.",
    ...
    return {
        ...
        html: wrapCampaignHtml({
            ...
            intro: "Thank you for the feedback you keep sharing with us. It is helping us improve Ground much faster.",
            bodyLead: "We wanted to give something back by extending your Early Stage access to 4 months at no cost and inviting you to explore the latest product improvements.",
            highlights: [
